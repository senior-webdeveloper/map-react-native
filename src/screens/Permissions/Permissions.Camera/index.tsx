...
import AssetImage from '../assets/camera.svg';
...
const PermissionCamera: React.FC = () => {
    ...
    <SafeAreaView style={{ flex: 1, justifyContent: 'space-between' }}>
      ...
      <Content>
        ...
        <TitleText style={{ marginTop: 31 }}>
          Permissão de acesso à Fotos
        </TitleText>
        <Text style={{ textAlign: 'center', marginTop: 16 }}>
          Para você poder usar as fotos do seu celular, precisamos que você
          permita que acessamos a sua galeria.
        </Text>
      </Content>
      <Content>
        <ButtonGreen
