...
import AssetImage from '../assets/notifications.svg';
...
const PermissionNotifications: React.FC = () => {
    ...
    <SafeAreaView style={{ flex: 1, justifyContent: 'space-between' }}>
      ...
      <Content>
        ...
        <Text style={{ textAlign: 'center', marginTop: 16 }}>
          Queremos te deixar por dentro das maiores novidades que rolam aqui
          dentro e para isso você precisa nos dar a sua permissão.
        </Text>
      </Content>
      <Content>
        <ButtonGreen
