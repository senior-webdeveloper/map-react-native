...
export function getOnPressClassification(
  ...
  handleNavigationDebounce: DebouncedFunc<(props) => void>,
  challenge_id: string,
  userChallenges: {
    __typename?: 'Query' | undefined | undefined;
        ...
        > & {
            ...
            > & {
                configuration?: Maybe<
                  { __typename?: 'ChallengeConfiguration' } & Pick<
                    ChallengeConfiguration,
                    'distance_goal_value' | 'altimetry_goal_value'
                  >
                >;
              };
          })
  ...
  subscribedDate: React.MutableRefObject<string>,
) {
  return () => {
    if (data?.getChallengeDetail) {
      if (data.getChallengeDetail.configuration?.classification_by_award) {
        handleNavigationDebounce({
          challenge_id,
          challenge: data?.getChallengeDetail,
          user_activities: userChallenges?.getSubscriptionProgress.activities,
          my_subscribed_date: subscribedDate.current,
          challenge_type: data?.getChallengeDetail.challenge_type,
          award: data.getChallengeDetail.awards,
          goal_altimetric:
            data.getChallengeDetail.configuration?.altimetry_goal_value > 1
              ? data.getChallengeDetail.configuration?.altimetry_goal_value
              : 1,
          goal_distance:
            data.getChallengeDetail.configuration?.distance_goal_value > 1
