...
const ChallengePaymentHistoric: React.FC<Props> = ({ route, navigation }) => {
  ...
  const [getPayments, { data }] = useFindPaymentLazyQuery({
    variables: { id: route.params.payment_id },
    onError: (e) => {
  ...
  return (
    ...
    >
      ...
      <ScrollView>
            ...
            <>
              {data.findPayment.bill_link ? (
                      ...
                      <StatsCard color="#FFC502">
                        <InnerStatsContainer>
                          ...
                          <Description>
                            ...
                            <DescriptionBold>
                              R${' '}
                              {String(data?.findPayment.value.toFixed(2))
                                .replace()
                                .replace('.', ',')}
                            </DescriptionBold>{' '}
                            ...
                            <DescriptionBold>
                              ...
                              {format(
                                new Date(
                                  data?.findPayment.bill_expiration_date,
                                ),
                                "dd'/'MM",
                              )}
                            </DescriptionBold>
                          ...
                          <View style={{ marginTop: 24, width: '100%' }}>
                            ...
                            <InfoContainer style={{ borderBottomWidth: 0 }}>
                              ...
                              <InfoDescription>
                                R${' '}
                                {String(
                                  data?.findPayment.value.toFixed(2),
                                ).replace('.', ',')}
                              </InfoDescription>
                            </InfoContainer>
                          </View>
                    ...
                    <PaymentStatusContainer color="#FFF">
                      <StatsCard color="#FF2525">
                        <InnerStatsContainer>
                          ...
                          <Description>
                            Seu boleto de R${' '}
                            {String(data?.findPayment.value.toFixed(2)).replace(
                              '.',
                              ',',
                            )}{' '}
                ...
                <>
                          ...
                          <InnerStatsContainer>
                            ...
                            <View style={{ marginTop: 24, width: '100%' }}>
                              ...
                              <InfoContainer>
                                ...
                                <InfoDescription>
                                  {format(
                                    new Date(data?.findPayment.created_at),
                                    "dd'/'MM'/'yyyy",
                                  )}
                                </InfoDescription>
                              </InfoContainer>
                              ...
                              <InfoContainer>
                                ...
                                <InfoDescription>
                                  {format(
                                    new Date(data?.findPayment.updated_at),
                                    "dd'/'MM'/'yyyy",
                                  )}
                                </InfoDescription>
                              </InfoContainer>
                        ...
                        <StatsCard color="#009D33">
                          <InnerStatsContainer>
                            <Icons
                              height={65}
                              name={
                                data?.findPayment.card?.brand || 'credit-card'
                              }
                            />
                            <AwaitTitle color="#009D33">
                  ...
                  {data && data?.findPayment.status === 'refused' && (
                    <PaymentStatusContainer color="#FFF">
                      <StatsCard color="#FF2525">
                        <InnerStatsContainer>
                          <AwaitTitle color="#FF2525">
        ...
        >
          <TitleText style={{ fontSize: 20 }}>Histórico</TitleText>
